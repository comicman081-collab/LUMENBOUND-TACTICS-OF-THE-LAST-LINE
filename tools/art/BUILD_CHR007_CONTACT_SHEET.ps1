...
$renderRoot = 'D:\AI 종합 폴더\Games\asset_share\blender_sources\characters\CHR007\renders'
$outputDir = Join-Path $ProjectRoot 'reports\r15\art_b\contact_sheets'
$outputPath = Join-Path $outputDir 'CHR007_STATIC_ART_R1_CONTACT_SHEET.png'
...
Draw-ArtPanel $graphics (Join-Path $renderRoot 'CHR007_ILLUSTRATION_MASTER_R1.png') 'MASTER RGBA' 32 32 980 720
Draw-ArtPanel $graphics (Join-Path $renderRoot 'CHR007_PORTRAIT_R1.png') 'WEB PORTRAIT RGBA' 1036 32 980 720
Draw-ArtPanel $graphics (Join-Path $renderRoot 'CHR007_ICON_R1.png') 'ICON RGBA' 32 784 980 720
Draw-ArtPanel $graphics (Join-Path $renderRoot 'CHR007_RUNTIME_ICON_R1.png') 'AUTHORING DERIVATIVE (NOT MAPPED)' 1036 784 980 720

$canvas.Save($outputPath, [System.Drawing.Imaging.ImageFormat]::Png)
$graphics.Dispose()
$canvas.Dispose()
Write-Output "CHR007_CONTACT_SHEET=$outputPath"
